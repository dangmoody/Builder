...
BUILDER_CALLBACK void set_builder_options( BuilderOptions* options ) {
	...
	options->compiler_path = "cl";	// but we recommend just doing this (in combination with compiler_version below) and letting builder figure out what version of MSVC you want
