...
sourceFiles="tests/tests_main.cpp src/builder.cpp src/visual_studio.cpp src/vs_code.cpp src/zed_editor.cpp src/backend_clang.cpp src/backend_msvc.cpp src/win_support.cpp\
	src/debug.cpp src/file.cpp src/hash.cpp src/hashmap.cpp src/intrinsics.clang.cpp src/linear_allocator.cpp src/math.cpp src/paths.cpp src/stb_impl.cpp src/string.cpp src/string_builder.cpp src/temp_storage.cpp\
	src/linux/*.cpp"
