...
set sourceFiles=tests\\tests_main.cpp src\\builder.cpp src\\visual_studio.cpp src\\core\\src\\core.suc.cpp src\\backend_clang.cpp src\\backend_msvc.cpp src\\win_sdk.cpp
